-- Autocmds. A LazyVim-flavored baseline. (The Sphere command was removed.)
...
-- Close some utility filetypes with just `q`.
...
-- Reload files changed on disk when regaining focus.
